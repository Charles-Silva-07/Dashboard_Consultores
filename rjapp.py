...
falta_faturamento = tab1_qtde_grupo['Falta'] = round(tab1_qtde_grupo['Realizado'] - tab1_qtde_grupo['Meta'])
...
falta_volume = tabela_1_de_volume_grupo['Falta'] = round(tabela_1_de_volume_grupo['Realizado'] - tabela_1_de_volume_grupo['Meta'])
